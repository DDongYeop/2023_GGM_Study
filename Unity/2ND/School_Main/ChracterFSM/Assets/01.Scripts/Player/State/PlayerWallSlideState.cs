...
{
    public PlayerWallSlideState(Player player, PlayerStateMachine stateMachine, string animationBoolTriggerName) : base(player, stateMachine, animationBoolTriggerName)
    {
    }
    ...
    {
        base.EnterState();
        //벽에 붙었을 때 점프를 할 수 있어야 해  플래이어 인풋의 점프 이벤트를 핸들링하는 함수가 있어야 한다.
