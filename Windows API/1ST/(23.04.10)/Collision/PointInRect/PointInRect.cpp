...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static RECT colRect = { 50, 50, 150, 150 };
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        if (PtInRect(&colRect, pt))
            MessageBox(hWnd, _T("충돌됨"), _T("Collision MSG BOX"), MB_OK);
        else
            MessageBox(hWnd, _T("충돌 안됨"), _T("Collision MSG BOX"), MB_OK);
    } break;
    case WM_PAINT:
        {
            PAINTSTRUCT ps;
            ...
            Rectangle(hdc, colRect.left, colRect.top, colRect.right, colRect.bottom);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
